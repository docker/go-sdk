...
# Should show: git@github.com:docker/go-sdk.git (or HTTPS equivalent)

# If it points to your fork, update it:
git remote set-url origin git@github.com:docker/go-sdk.git

# Then run (from the main branch):
...
The script will validate the origin remote, create a release branch, bump versions, push, and open a PR.
